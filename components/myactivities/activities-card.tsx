  ...
  return (
    <>
      <div className="relative">
        <div
          key={data.id}
          className="flex items-center gap-2 overflow-hidden rounded-3xl bg-white shadow-sidenavi-box dark:bg-dark-secondary dark:bg-sky-100/20 tablet:gap-3 pc:h-204pxr pc:gap-6"
        >
